...
dataset_name = st.sidebar.selectbox("Select Dataset", ("Iris", "Breast Cancer", "Diabetes" ,"Wine Dataset"))
...
st.write("no. of classes in dataset is ", len(np.unique(y)))
...
def get_classifier(clf_name, params):
    if clf_name == "KNN":
        ...
        clf = RandomForestClassifier(n_estimators=params["n_estimators"],
                                     max_depth=params["max_depth"], random_state=4321)
    return clf
